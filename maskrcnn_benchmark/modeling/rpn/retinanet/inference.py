...
def make_retinanet_postprocessor(cfg, rpn_box_coder, is_train):
    pre_nms_thresh = cfg.MODEL.RETINANET.INFERENCE_TH
    pre_nms_top_n = cfg.MODEL.RETINANET.PRE_NMS_TOP_N
    nms_thresh = cfg.MODEL.RETINANET.NMS_TH
    fpn_post_nms_top_n = cfg.TEST.DETECTIONS_PER_IMG
    num_classes=cfg.MODEL.RETINANET.NUM_CLASSES
    min_size = 0

    if cfg.MODEL.SAMPLING_FREE_ON:
        from maskrcnn_benchmark.modeling.sampling_free import adaptive_threshold
        pre_nms_thresh = adaptive_threshold(cfg, num_classes)
        nms_thresh = 0.55
